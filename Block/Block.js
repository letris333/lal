...
export default class Block extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("1", "./Block/costumes/1.png", { x: -20, y: 30 }),
      new Costume("2", "./Block/costumes/2.png", { x: -10, y: 40 }),
      new Costume("3", "./Block/costumes/3.png", { x: -10, y: 40 }),
      new Costume("4", "./Block/costumes/4.png", { x: -10, y: 40 }),
      new Costume("5", "./Block/costumes/5.png", { x: -10, y: 40 }),
      new Costume("6", "./Block/costumes/6.png", { x: -10, y: 40 }),
      new Costume("7", "./Block/costumes/7.png", { x: -10, y: 40 })
    ];
  ...
  *whenGreenFlagClicked() {
    ...
    while (true) {
      ...
      this.vars.reachedBottom = 0;
      this.costume = this.sprites[undefined].costume.name;
